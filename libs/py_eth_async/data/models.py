...
from libs.py_eth_async import config
from libs.py_eth_async.blockscan_api import APIFunctions
from libs.py_eth_async.utils import checksum
...
class Network(AutoRepr):
    ...
    def __init__(
            ...
            dex: Optional[DEX] = None, cex: Optional = None, cex_network: Optional = None,
    ) -> None:
        """
...
class Networks:
    ...
    Linea = Network(
        ...
        api=API(key=config.LINEA_API_KEY, url='https://api.lineascan.build/api', docs='https://docs.lineascan.build/'),
    )
    zkSync = Network(
        name='zksync',
